...
if __name__ == "__main__":
    ...
    # (3) Disable reset and register upload; force stream ctrl
    ...
    # (3) Disable base register sequence upload and skip reset between captures
    ...
    # (5) Manually power off the sensor
    print(f"Manually power off the sensor via V4L2 interface.")
    i2c.rwReg(addr=0x0, value=0, rw=1, flag=i2c.AMS_CAMERA_CID_MIRA016_REG_FLAG_POWER_OFF)
