...
if __name__ == "__main__":
    ...
    i2c.rwReg(addr=0x0011, value=0x00, rw=1, flag=i2c.AMS_CAMERA_CID_MIRA016_REG_FLAG_USE_BANK)
    ...
    i2c.rwReg(addr=0x011D, value=0x01, rw=1, flag=i2c.AMS_CAMERA_CID_MIRA016_REG_FLAG_USE_BANK)
