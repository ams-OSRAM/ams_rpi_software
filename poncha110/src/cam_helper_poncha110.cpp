 ...
 *
 * cam_helper_poncha110.cpp - camera helper for poncha110 sensor
 */
...
/*
 * We have observed that the poncha110 embedded data stream randomly returns junk
 ...
 * addresses from the poncha110 datasheet:
 */
...
class CamHelperPoncha110 : public CamHelper
{
public:
	CamHelperPoncha110();
...
private:
	...
	* PONCHA110_ROW_TIME_1600x1400_1000GBS_US=(300*26.04/1000)=7.8us
	* PONCHA110_ROW_TIME_640x480_1000GBS_US=(450*26.04/1000)=11.7us
	*/
...
CamHelperPoncha110::CamHelperPoncha110()
#if ENABLE_EMBEDDED_DATA
...
// Duration CamHelperPoncha110::exposure(uint32_t exposureLines,
// 				   [[maybe_unused]] const Duration lineLength) const
// {
// 	Duration timePerLine;
...
// unsigned int CamHelperPoncha110::mistrustFramesModeSwitch() const
// {
// 	/*
...
// bool CamHelperPoncha110::sensorEmbeddedDataPresent() const
// {
// 	return ENABLE_EMBEDDED_DATA;
// }

// void CamHelperPoncha110::populateMetadata(const MdParser::RegisterMap &registers,
...
{
	return new CamHelperPoncha110();
}

static RegisterCamHelper reg("poncha110", &create);
